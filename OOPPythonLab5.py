...
class Library:
    ...
    def search_books(self, keyword):
        ...
        results = [book for book in books if keyword.lower() in book.get_title().lower() or keyword.lower() in book.get_author().lower()]
        if results:
            print("\nSearch Results:")
            for book in results:
                print(book)
...
class OperatorUser(User):
    def view_library(self, library):
        ...
        print("You are browsing as Operator User. You can search and preview books, add, delete books, and clear library catalog.")
    def search_books(self, library):
